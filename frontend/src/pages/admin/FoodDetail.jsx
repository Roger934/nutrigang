...
const FoodDetail = () => {
  ...
  if (!food) {
    return (
      <section className="card">
        ...
        <Link to="/admin/foods" className="font-semibold text-emerald-700">
          Volver al catalogo
        </Link>
      </section>
    );
  ...
  return (
    <section className="card">
      <p className="text-sm font-semibold text-emerald-600">Detalle del alimento #{food.id}</p>
      ...
      <Link to="/admin/foods" className="mt-6 inline-block font-semibold text-emerald-700">
        Volver al catalogo
      </Link>
    </section>
  );
